          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              <button
                ...
                aria-label="Open contact form to schedule a discovery call"
              >
